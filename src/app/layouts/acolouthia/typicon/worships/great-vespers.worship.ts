import { acclamatia, hallelujah, приидитеПоклонимсяТрижды, славаИНыне } from '../../texts';
...
export function greatVespers({ vigil, count, глас }: greatVespersConfig): Replica[] {
  const { благословенБогНаш } = acclamatia;

  const начало = vigil
    ? [
      // TODO: Переносим отсюда в компонент vespers
      ...стихирыГосподиВоззвах(глас, count),
    ]
    : [
      благословенБогНаш,
      ...
      славаИНыне(),
      ...hallelujah(),
      { doer: Doer.Чтец, text: 'Господи помилуй, трижды' },
      славаИНыне(),
      ...стихирыГосподиВоззвах(глас, count),
    ];
