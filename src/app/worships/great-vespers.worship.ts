...
export function greatVespers(): Replica[] {
  return [
    ...
    { doer: Doer.Чтец, text: 'Слава, и ныне, аллилуиа, трижды' },
    { doer: Doer.Чтец, text: 'Господи помилуй, трижды' },
    { doer: Doer.Чтец, text: 'Слава, и ныне:' },
